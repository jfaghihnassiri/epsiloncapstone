...
LOCAL_SRC_FILES = ../../../../../qcar/build/lib/$(TARGET_ARCH_ABI)/libQCAR.so
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/../../../../../qcar/build/include
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := GDX-prebuilt
LOCAL_SRC_FILES = ../../../../../libgdx/libgdx-0.9.2/$(TARGET_ARCH_ABI)/libgdx.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := ANDROIDGL20-prebuilt
LOCAL_SRC_FILES = ../../../../../libgdx/libgdx-0.9.2/$(TARGET_ARCH_ABI)/libandroidgl20.so
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SRC_FILES := ImageTargets.cpp SampleUtils.cpp Texture.cpp QCARManager.cpp

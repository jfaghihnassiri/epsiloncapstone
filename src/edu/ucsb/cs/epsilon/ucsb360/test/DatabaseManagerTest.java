...
//		
//		try {
//			DatabaseManager.getUsr(user[0]);
//			assertEquals(user[0], User.getUsername());
//			assertEquals(user[1], User.getName());
//			assertEquals(user[2], User.getBirthday());
//			assertEquals(user[3], User.getGender());
//			assertEquals(user[4], User.getNumAugsCreated());
//			assertEquals(user[5], User.getNumAugsShared());			
...
//		try {
//			DatabaseManager.getUsr(user[0]);
//			int shares = User.getNumAugsShared();
//
//			assertTrue(DatabaseManager.incUsrAugsShared());
//			
//			DatabaseManager.getUsr(user[0]);
//			assertEquals(shares+1, User.getNumAugsShared());
//		} catch (SQLException e) {
//			fail(e.getMessage());
//		}
//		
...
//		try {
//			DatabaseManager.getUsr(user[0]);
//			int created = User.getNumAugsCreated();
//			
//			assertTrue(DatabaseManager.incUsrAugsCreated());
//			
//			DatabaseManager.getUsr(user[0]);
//			assertEquals(created+1, User.getNumAugsCreated());
//		}
//		catch (SQLException e) {
//			fail(e.getMessage());
//		}
